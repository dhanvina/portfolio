    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
       ...
       <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 sm:mb-12 gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-bold text-white tracking-tight">MLOPS_PIPELINE</h2>
        ...
        <div className="flex gap-3 w-full sm:w-auto">
           {isRunning ? (
             <button disabled className="flex-grow sm:flex-grow-0 flex items-center justify-center gap-2 px-6 py-2 bg-neutral-800 text-neutral-500 text-xs font-bold tracking-wider rounded cursor-wait">
               EXECUTING...
             </button>
           ) : (
             <button 
               onClick={runPipeline}
               className="flex-grow sm:flex-grow-0 flex items-center justify-center gap-2 px-6 py-2 bg-white hover:bg-green-500 text-black hover:text-white text-xs font-bold tracking-wider rounded transition-all hover:shadow-[0_0_20px_rgba(34,197,94,0.4)]"
             >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7">
           <div className="relative border border-neutral-800 bg-black p-4 sm:p-8 min-h-[500px] sm:min-h-[600px] flex flex-col justify-center overflow-hidden">
                ...
                {STAGES.map((stage, index) => {
                  ...
                  return (
                    <div key={stage.id} className="relative">
                      ...
                      <div className={`flex items-center gap-4 sm:gap-6 py-2 transition-all duration-500 ${isActive ? 'translate-x-2' : ''} ${status === 'pending' ? 'opacity-50' : 'opacity-100'}`}>
                        ...
                        {/* Stage Card */}
                        <div className={`
                          flex-grow p-3 sm:p-4 border rounded-sm flex items-center justify-between transition-all duration-300 relative overflow-hidden
                        ...
                        `}>
                          ...
                          <div className="flex-grow min-w-0 mr-2">
                            ...
                            <div className="text-[10px] font-mono text-neutral-500 mt-1 truncate max-w-full">
                               {status === 'running' ? '>> Executing process...' : stage.command}
                            </div>
                          </div>
                          
                          <div className={`text-[10px] font-mono whitespace-nowrap ${status === 'completed' ? 'text-green-600' : 'text-neutral-600'}`}>
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          ...
          {/* Status Monitor */}
          <div className="border border-neutral-800 bg-neutral-900/20 p-4 sm:p-6">
             ...
             <div className="grid grid-cols-2 gap-2 sm:gap-4">
                <div className="p-3 sm:p-4 bg-black border border-neutral-800">
                   <div className="text-[10px] text-neutral-500 mb-1">BUILD STATUS</div>
                   <div className={`font-mono font-bold text-sm sm:text-base ${isRunning ? 'text-yellow-500' : stageStatuses['deploy'] === 'completed' ? 'text-green-500' : 'text-neutral-300'}`}>
                ...
                <div className="p-3 sm:p-4 bg-black border border-neutral-800">
                   ...
                   <div className="font-mono font-bold text-sm sm:text-base text-white">v2.4.1</div>
                </div>
                <div className="p-3 sm:p-4 bg-black border border-neutral-800">
                   <div className="text-[10px] text-neutral-500 mb-1">ACTIVE CLUSTER</div>
                   <div className="font-mono font-bold text-sm sm:text-base text-green-500">US-EAST-1</div>
                </div>
                <div className="p-3 sm:p-4 bg-black border border-neutral-800">
                   <div className="text-[10px] text-neutral-500 mb-1">HEALTH CHECK</div>
                   <div className="font-mono font-bold text-sm sm:text-base text-green-500">99.9% UP</div>
                </div>
             </div>
          </div>
