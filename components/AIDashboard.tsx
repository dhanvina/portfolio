...
const SystemHeartbeat: React.FC = () => {
  ...
  return (
    <div className="h-full w-full flex flex-col">
      <div className="flex justify-between items-center px-4 py-1.5 border-b border-neutral-800 bg-neutral-900/50">
      ...
      <div className="flex-grow bg-black relative overflow-hidden min-h-[100px]">
...
const NetworkVisualizer: React.FC = () => {
  return (
    <div className="h-full w-full bg-black relative overflow-hidden flex flex-col">
      <div className="px-4 py-1.5 border-b border-neutral-800 bg-neutral-900/50 flex justify-between">
        <div className="text-[10px] text-neutral-400 font-mono flex items-center gap-2">
      ...
      <div className="flex-grow relative flex items-center justify-center min-h-[100px]">
...
const AIDashboard: React.FC = () => {
  return (
    <div className="w-full max-w-7xl mx-auto border border-neutral-800 bg-neutral-950/80 shadow-2xl relative overflow-hidden flex flex-col">
      ...
      {/* Dashboard Header */}
      <div className="h-10 border-b border-neutral-800 flex items-center justify-between px-4 bg-neutral-900 relative z-20 flex-shrink-0">
        <div className="flex items-center gap-3">
          <div className="flex gap-1.5">
            <div className="w-2.5 h-2.5 rounded-full bg-red-500/20 border border-red-500/50" />
            <div className="w-2.5 h-2.5 rounded-full bg-yellow-500/20 border border-yellow-500/50" />
            <div className="w-2.5 h-2.5 rounded-full bg-green-500 border border-green-400 animate-pulse" />
          </div>
          <span className="text-[10px] font-mono text-neutral-400 tracking-widest">NEURAL_OPS_CENTER</span>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 h-auto lg:h-[420px]">
        ...
        <div className="lg:col-span-9 bg-black relative flex flex-col h-[350px] lg:h-full">
          {/* Terminal Header */}
      ...
      {/* Dashboard Footer */}
      <div className="h-7 border-t border-neutral-800 bg-neutral-900 flex items-center px-4 justify-between flex-shrink-0">
